...
public class UserService {
    ...
    public void create(String username, String password, String email) throws Exception {
        ...
        var gsUserEntity = UserEntity.builder().userID(username).userPass(password).userEmail(email).userType(UserType.player.code).build();
        mUserRepository.saveAndFlush(gsUserEntity);
    }
